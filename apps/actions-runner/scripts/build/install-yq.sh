...
yq_url=$(resolve_github_release_asset_url "mikefarah/yq" "endswith(\"yq_linux_${dpkg_arch}\")" "latest")
...
external_hash=$(get_checksum_from_url "${hash_url}" "yq_linux_${dpkg_arch} " "SHA256" "true" " " "19")
