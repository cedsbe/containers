...
gh_cli_url=$(resolve_github_release_asset_url "cli/cli" "contains(\"linux\") and contains(\"${dpkg_arch}\") and endswith(\".deb\")" "latest")
...
external_hash=$(get_checksum_from_url "$hash_url" "linux_${dpkg_arch}.deb" "SHA256")
